...
export default function VivekCard() {
  ...
  const title = "Founder · Business & Growth";
  const company = "Savitron.ai";
  const email = "vivek@savitron.ai";
  const phone = "+917838136381";
  const phoneDisplay = "+91 78381 36381";
  const linkedin = "https://www.linkedin.com/in/vivek-sharma-25704867";
  const website = "https://savitron.ai/";
  const photo = "/images/static/team/vivek-sharma.jpg";
  const vcfUrl = "/vcf/vivek.vcf";
  const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://savitron.ai/vivek`;

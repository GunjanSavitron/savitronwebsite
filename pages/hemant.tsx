...
export default function HemantCard() {
  const name = "Hemant Pandey";
  const title = "Co-Founder · AI Transformation";
  const company = "Savitron.ai";
  const email = "hemant@savitron.ai";
  const phone = "+919810659551";
  const phoneDisplay = "+91 98106 59551";
  const linkedin = "https://www.linkedin.com/in/pandeyhemant/";
  const website = "https://savitron.ai/";
  const photo = "/images/static/team/Hemand_Pandey.jpeg";
  const vcfUrl = "/vcf/hemant.vcf";
  const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://savitron.ai/hemant`;

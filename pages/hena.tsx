...
export default function HenaCard() {
  const name = "Hena Agrawal";
  const title = "Co-Founder · Financial Intelligence";
  const company = "Savitron.ai";
  const email = "hena@savitron.ai";
  const phone = "+919916600370";
  const phoneDisplay = "+91 99166 00370";
  const linkedin = "https://www.linkedin.com/in/hena-agrawal-211aa056";
  const website = "https://savitron.ai/";
  const photo = "/images/static/team/hena-agrawal.jpg";
  const vcfUrl = "/vcf/hena.vcf";
  const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://savitron.ai/hena`;
